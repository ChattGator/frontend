		...
		<>
			...
			<div className="flex items-center justify-evenly mt-3 mb-3">
				...
				<div className="space-y-1">
					<span className="block text-left font-medium text-md">Group Name</span>
					<span className="block text-left font-light text-sm">Total Members: 50 | Lorem ipsum dolor sit amet.</span>
				</div>
