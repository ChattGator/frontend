...
const ProjectCard: FC<Props> = ({ link, title, description, createdAt }) => {
	return (
		<Link href={link}>
			<a className="grid aspect-video place-content-center gap-2 rounded-lg border-2 border-slate-200 bg-white p-4 text-center drop-shadow-sm transition-all hover:border-blue-600 hover:shadow-blue-200 active:bg-blue-100 lg:gap-4 lg:p-8">
